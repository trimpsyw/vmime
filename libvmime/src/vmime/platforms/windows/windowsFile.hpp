...
private:
	...
	// FIX by Elmue: changed
	vmime::wstring m_nativePath;
};
...
public:
	// FIX by Elmue: changed
	windowsFileIterator(const vmime::utility::file::path& path, const vmime::wstring& nativePath);
	~windowsFileIterator();
...
public:
	// FIX by Elmue: changed
	windowsFileReader(const vmime::utility::file::path& path, const vmime::wstring& nativePath);
...
public:
	...
	// FIX by Elmue: changed
	windowsFileWriter(const vmime::utility::file::path& path, const vmime::wstring& nativePath);
